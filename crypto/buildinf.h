  ...
  #define CFLAGS "compiler: cl -DDEBUG -D_DEBUG  /MD /Ox /O2 /Ob2 -DOPENSSL_THREADS  -DDSO_WIN32 -DDEBUG -D_DEBUG -W3 -Gs0 -GF -Gy -nologo -DOPENSSL_SYSNAME_WIN32 -DWIN32_LEAN_AND_MEAN -DL_ENDIAN -D_CRT_SECURE_NO_DEPRECATE -DOPENSSL_USE_APPLINK -I. -DOPENSSL_NO_RC5 -DOPENSSL_NO_MD2 -DOPENSSL_NO_KRB5 -DOPENSSL_NO_JPAKE -DOPENSSL_NO_STATIC_ENGINE    "
  #define PLATFORM "VC-WIN32"
  #define DATE "Thu Aug  9 15:10:18 2018"
#endif
